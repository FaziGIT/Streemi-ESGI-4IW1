 ...
 */
final class Version20241127140002 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO serie (id) SELECT id FROM __temp__serie');
        $this->addSql('DROP TABLE __temp__serie');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, current_subscription_id, username, email, password, account_status FROM user');
        ...
        $this->addSql('INSERT INTO user (id, current_subscription_id, username, email, password, account_status) SELECT id, current_subscription_id, username, email, password, account_status FROM __temp__user');
